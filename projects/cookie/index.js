...
addButton.addEventListener('input', function () {
...
function updateTable() {
  ...
  for (const [name, value] of cookiesMap) {
    ...
    const valueTD = document.createElement('tr');
    const removeTD = document.createElement('tr');
    const removeButton = document.createElement('button');

    removeButton.dataset.role = 'remove-coolie';
